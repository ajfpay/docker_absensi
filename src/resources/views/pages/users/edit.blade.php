                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('department')
                                is-invalid
                            @enderror" name="department" value="{{ $user->department }}">
                            @error('department')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            <label>Picture</label>
                            <input type="text" class="form-control @error('img_url')
                                is-invalid
                            @enderror" name="img_url" value="{{ $user->img_url }}">
                            @error('img_url')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="selectgroup w-100">
                                ...
                                <label class="selectgroup-item">
                                    <input type="radio" name="role" value="staff" class="selectgroup-input" @if ($user->role == 'doctor') checked @endif>
